...
{    
    ...
    {
        AddWeaponIntoActiveSlot(newWeapon);
    }

    private void AddWeaponIntoActiveSlot(GameObject newWeapon)
    {
        DropCurrentWeapon(newWeapon);
    ...
    private void DropCurrentWeapon(GameObject newWeapon)
    {
        if (activeWeaponSlot.transform.childCount > 0)
        {
            ...
            weaponToDrop.transform.SetParent(newWeapon.transform.parent);
            weaponToDrop.transform.localPosition = newWeapon.transform.localPosition;
            weaponToDrop.transform.localRotation = newWeapon.transform.localRotation;
        }
    }
